...
export type OnImageAddedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type OnImageAddedSubscription = { __typename?: 'Subscription', images: { __typename?: 'Image', id: number, url: string } };
...
export const OnImageAddedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"OnImageAdded"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"images"},"name":{"kind":"Name","value":"imageAdded"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}}]} as unknown as DocumentNode<OnImageAddedSubscription, OnImageAddedSubscriptionVariables>;